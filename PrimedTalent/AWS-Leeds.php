...
<body style="overflow-x: hidden">
    ...
    <!-- <div class="text-on-img6">
        <div class="overlay-img">
            <img src="Assets/Images/aws.jpg" class="img-fluid w-100 awscarousel" alt="" />
        </div>
      
    <img class="img-fluid awslogo" src="/Assets/Images/awslogo.png" alt="">
    <img class="img-fluid awslogo2" src="/Assets/Images/awslogo2.png" alt="">
    <h1 class="awstext">Made redundant recently? A career in Tech awaits you after completion of training with us!
    </h1>
    <div class="btn-container">
        <a href="AWS-Edinburgh">
            <button class="btn carbtn carbtn1">Edinburgh</button>
        </a>
        <a href="AWS-Leeds">
            <button class="btn carbtn carbtn2">Leeds</button>
        </a>
        <a href="AWS-Sheffield">
            <button class="btn carbtn carbtn3">Sheffield</button><br>
        </a>
        <a href="AWS-Leicester">
            <button class="btn carbtn carbtn4">Leicester</button>
           
        </a>
        <a href="AWS-Derby">
            <button class="btn carbtn carbtn5">Derby</button>
           
        </a>
        <a href="AWS-Nottingham">
            <button class="btn carbtn carbtn6">Nottingham</button><br>
           
        </a>
        <a href="AWS-Glasgow">
            <button class="btn carbtn carbtn7">Glasgow</button>
           
        </a>
        <a href="AWS-Aberdeen">
            <button class="btn carbtn carbtn8">Aberdeen</button>
           
        </a>
        <a href="AWS-Dundee">
            <button class="btn carbtn carbtn9">Dundee</button>
        </a>
    </div>
    <h1 class="awstext1">Choose a city</h1>
    <h1 class="awstext2 text-center">You could be living here or are willing to relocate to the city of your choice
    </h1>
    <h1 class="miltext">If you're from <b>Military</b> please <a href="AWS-Military">Click here!</a></h1>
    ...
    <div class="container aws-cities-container">
        <h2 class="text-center mt-4 font-weight-bold">Select city</h2>
        <ul class="aws-cities-ul">
            <a class="carbtn2" href="AWS-Leeds">
                <li>Leeds</li>
            </a>
            <a href="">
                <li>Edinburgh</li>
        ...
        <p class="text-center">*You could be living here or are willing to relocate to the city of your choice
    </p>
    </div>
    ...
    <div class="container smpara">
        ...
        <div class="container embed-container text-center mt-4 mb-5">
            <iframe src="https://www.youtube.com/embed//iOHZo_C1Atw" frameborder="0" allowfullscreen></iframe>
        </div>
    </div>
    ...
    <section>
        ...
        <table class="table table-hover mt-4">
            ...
            <tbody>
                ...
                <tr>
                    <td>East Midlands (Leicester, Derby, Nottingham)</td>
                    <td>20-Feb-21</td>
                </tr>
                <tr>
                    <td>Cambridge
                ...
                <tr>
                    <td>Blackpool / Sunderland / Hull / Gateshead</td>
                    <td>24-May-21
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Dundee / Glasgow / Edinburgh / Aberdeen</td>
                    <td>15-Sep-2021</td>
                </tr>
                <tr>
                    <td>Newcastle</td>
            ...
            <p class="mt-4 pfont">We are currently running a special drive for early career
                professionals who have
                been
                made redundant
                recently. Professionals from Retail and Hospitality are encouraged to apply.</p>
    ...
    <div class="modal fade contmodal" id="formmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 100000000">
        <div class="modal-dialog modal-dialog-centered modal-dialog-cont" role="document">
            <div class="modal-content">
                ...
                <br />
                <form class="cuform" action="awsprocess-leeds.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row row-sm-offset">
                        ...
                        <div class="col-md-12 multi-horizontal" data-for="date">
                            <div class="form-group">
                            <label class="form-control-label mbr-fonts-style display-7">Date of cohort*</label>
                                <select class="form-control form-inline" name="date">
                                    <option value="" disabled selected hidden>Please select</option>
                                    <option value="0">19-Jul-2021</option>
                                </select>
                            </div>
                        </div>
                        <!-- <div class="col-md-12 multi-horizontal" data-for="phone">
                            <div class="form-group">
                                <label class="form-control-label mbr-fonts-style display-7">Age*</label>
                                ...
                                <input class="form-control mt-3" type="text" placeholder="Please specify*"
                                    name="indother" id="indother" />
                            </div>
                        </div> -->
                    </div>

                    <div class="form-group mb-0" data-for="Exp">
                        <label class="form-control-label mbr-fonts-style display-7" for="message-form1-2w">Do you have
                            work experience?*</label><br />
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="Exp" id="inlineRadio3" value="Yes" required />
                            <label class="form-check-label" for="inlineRadio3">Yes</label>
                        </div>
                        <div class="form-check form-check-inline mr-0">
                            <input class="form-check-input" type="radio" name="Exp" id="inlineRadio4" value="No" required />
                        </div>
                    ...
                    <div style="padding:0px 13px">
                        <div class="form-group">
                            <label for="years" id="expinplabel">Number of Years and Months*</label>
                            <div class="row">
                                <div class="col">
                                    <select class="form-control form-inline" name="years" id="expinp">
                                ...
                                <div class="col">
                                    <select class="form-control form-inline" name="months" id="expinp2">
                        ...
                        <input class="form-control mt-3 mb-3" type="text" placeholder="Last job role*" name="ljr" id="jobinp" />

                        <!-- <div class="form-group">
                            <label for="resume" class="form-control-label">Paste your resume*</label>
                            <textarea id="fileinptext" class="form-control" name="resume" cols="30" rows="10"></textarea>
                        </div> -->

                        <div class="col-md-12 multi-horizontal em" data-for="attachment" id="fileinp">
                            <div class="form-group">
                                <label class="form-control-label mbr-fonts-style display-7" for="name-form1-2w">Upload resume*(Only pdf, jpg, jpeg, png, doc, docx formats are allowed)</label>
                                <input id="fileinptext" type="file" name="attachment" class="form-control">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="form-control-label mbr-fonts-style display-7" id="secinplabel">Industry*</label>
                            <select class="form-control" id="secinp" name="industry" onchange="checkvalue2(this.value)">
                                <option value="" disabled selected hidden>Please select</option>
                            ...
                            <input class="form-control mt-3" type="text" placeholder="Please specify*" name="indother" id="indother" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <!-- <div class="form-group" data-for="ExMilitary">
                        <label class="form-control-label mbr-fonts-style display-7" for="message-form1-2w">Are you
                            ex-Military*</label><br />
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="ExMilitary" id="inlineRadio1"
                                value="Yes" />
                            <label class="form-check-label" for="inlineRadio1">Yes</label>
                        </div>
                        <div class="form-check form-check-inline mr-0">
                            <input class="form-check-input" type="radio" name="ExMilitary" id="inlineRadio2"
                                value="No" />
                        </div>
    ...
    <div id="fileerrormodal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered thankmodal">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <h5 class="text-center">Sorry, only PDF, DOC, JPG, JPEG, & PNG files are allowed to upload.</h5>
                </div>
                <div class="modal-footer"></div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            if (window.location.href.indexOf('?fileerror') != -1) {
        ...
        $(document).ready(function() {
            if (window.location.href.indexOf('#scroll') == -1) {
                setTimeout(function(){ window.location.href+="#scroll"; }, 500);
            }
        });
