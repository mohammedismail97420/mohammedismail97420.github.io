...
<body style="overflow-x: hidden">
    ...
    <div class="container aws-cities-container">
        ...
        <p class="text-center">To know about the cohort date <a href="#scroll">Click here</a></p>
    </div>
    ...
    <div class="container mt-4">
        ...
        <table class="table table-hover mt-4">
            ...
            <tbody>
                ...
                <tr>
                    <td>East Midlands (Leicester, Derby, Notts)</td>
                    <td>20-Feb-21
                    </td>
                </tr>
                <tr>
    ...
    <div class="modal fade alertmodal" id="formmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 100000000">
        <div class="modal-dialog modal-dialog-centered modal-dialog-cont" role="document">
            <div class="modal-content">
                ...
                <h4 class="text-center">Please select the city</h4>
