...
$(document).ready(function () {
  $("input:radio[name=Exp]").change(function () {
    if (this.value == "Yes") {
      document.getElementById("fileinp").style.width = "100%";
      document.getElementById("fileinp").style.height = "100%";
      document.getElementById("fileinp").style.opacity = "1";
      document.getElementById("fileinp").style.float = "none";
      document.getElementById("fileinptext").setAttribute("required", "");
    } else if (this.value == "No") {
      document.getElementById("fileinp").style.width = "0";
      document.getElementById("fileinp").style.height = "0";
      document.getElementById("fileinp").style.padding = "0";
      document.getElementById("fileinp").style.opacity = "0";
      document.getElementById("fileinp").style.float = "right";
      document.getElementById("fileinptext").removeAttribute("required");
    }
  });
});
