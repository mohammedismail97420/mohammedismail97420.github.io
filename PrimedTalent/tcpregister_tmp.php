    ...
    ">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link cont conttrial" href="freetrial.php">&nbsp;&nbsp;&nbsp;Book a Free
                            Trial</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 shadow px-4  mb-5">
                    <div class="formcony form">
                        <form action="tcpregisterprocess_tmp.php" method="post">
                        ...
                        ?>
							...
							// Create connection
								...
								$sql = "SELECT courseid,coursename,price,status FROM   `tcp_course_master_temp` order by courseid";
