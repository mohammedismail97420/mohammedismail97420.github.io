...
<body>
    ...
    <div class="container text-center" style="min-height:58vh">
        ...
        <h5 class="mt-5"> Dear <?php echo $name ?>,You have decided to purchase the below Course being offerd by QA
            (www.qa.com).
        ...
        <form class="mb-5" action="verify.php" method="POST">
