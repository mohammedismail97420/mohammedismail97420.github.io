...
<head>
	...
	<meta name="description" content=" Take courses in business, programming, technological everything in one place. Prepare yourself for the future. ">
	<meta name="keywords" content="AWS, Amazon, Project Management, Excel, C, C++,Cobol, Devops, CompTIA, Professional Development, Managing Successful Programme, MSP, RedHat, QA, Virtual Classroom, Extended Classroom, Virtual seat in a live Class">
    ...
    <div class="container mt-3 mb-5">
        ...
        <div class="row mt-5">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6" style="text-align:justify">
                <p>QA (<a style="text-decoration:none" href="https://www.qa.com">www.qa.com</a>) started in 1985 and is UK’s leading digital education and skills providers with a
                    presence in
        ...
        <br>
        <p class="mt-3 mb-5">The technical courses offered run in the hundreds and cut across the Application, Infrastructure,
        ...
        <div class="dropdown mb-5">
                ...
                <select class="form-control w-100 mt-5" name="coursevalue" id="coursevalue"  style="display:none;" onchange="showData_new(this.value)">
        ...
        var mainJsonData={};
                ...
                function getCourse(value){
                    ...
                    // alert(JSON.stringify(second_json));
                    $('#coursevalue').find('option').remove().end();
                ...
                for (var i = 0; i < courseDetailsList.length; i++) {
                    ...
                    html +="<tr>"                                                
                            ...
                            +"<td>"+duration+"</td>"
                            +"<td>"+finalPrice+"</td>"
                            +"<td><div><a class='btn btn-primary text-white' href='./register.php?courseId="+Course_ID+"&CourseTitle="+CourseTitle+"&eventId="+temp.eventId+"&eventDate="+eventDate+"&finalPrice="+finalPrice1+"'>Request</a></div></td>"
                            +"</tr>";
                            datacount++;
                }
        ...
        <ol class="ml-3" style="line-height:2rem">
            ...
            <li> A list with different course dates will be displayed. Choose your preferred date and click on the
                "request button".</li>
...
<h4 class="mt-5"><b>Did not find what you were looking for?</b></h4>
        <p>Please <a href="contact_us.php">contact us</a> and we will reach out to you within the next 24 hours.
        </p>
    </div>
